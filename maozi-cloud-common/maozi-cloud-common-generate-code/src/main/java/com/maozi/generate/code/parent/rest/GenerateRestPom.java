...
package com.maozi.generate.code.parent.rest;
...
public class GenerateRestPom {
	...
	public static void generate(String module,String pash) throws Exception {
		...
		String context = "<project xmlns=\"http://maven.apache.org/POM/4.0.0\"\r\n" + 
				...
				"		<dependency>\r\n" + 
				"			<groupId>com.maozi</groupId>\r\n" + 
				"			<artifactId>maozi-cloud-"+module+"-vo</artifactId>\r\n" + 
				"			<version>${maozi-cloud-"+module+"-vo.version}</version>\r\n" + 
				"		</dependency>\r\n" + 
				"\r\n" + 
				"		<dependency>\r\n" + 
				"			<groupId>com.maozi</groupId>\r\n" + 
				"			<artifactId>maozi-cloud-"+module+"-dto</artifactId>\r\n" + 
				"			<version>${maozi-cloud-"+module+"-dto.version}</version>\r\n" + 
				"		</dependency>\r\n" + 
				"\r\n" + 
				"		<dependency>\r\n" + 
				"			<groupId>com.maozi</groupId>\r\n" + 
